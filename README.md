...
| **commands_index.md** | Индекс всех доступных команд (52 шт с категориями) |
...
- **commands_index.md** — быстрый grep-справочник команд
...
Если пользователь пишет «запомни» — информация сохраняется в наиболее подходящий файл `~/.neuro-os/*` (выбор по контексту: AGENTS.md / IDENTITY.md / SOUL.md / commands_index.md).
